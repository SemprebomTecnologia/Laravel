...
<head>
    ...
    <title>
        GERENCIAMENTO SITE - CAMARGO ADVOCACIA
    </title>
...
<body class="">
    ...
    <div class="content"
        style="text-align: center; width: 70%; height: auto; margin-left: auto; margin-right: auto; padding-top: 100px;">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-11">
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <p class="card-category">GERENCIAMENTO SITE - CAMARGO ADVOCACIA</p>
                        </div>
                        <div class="card-body">
    ...
    <div>
        <div class="wrapper ">
            ...
            <div class="col-md-4">
                <button class="btn btn-primary btn-block d-none " id="meuElemento"
                    onclick="demo.showNotification('top','left', 'Por Favor Verifique seu Usuario e Senha')">Top
                    Right</button>
            </div>
    ...
    $(document).ready(function() {
        demo.showNotification('top', 'left', 'Por Favor Verifique seu Usuario e Senha')
    });
    </script>
